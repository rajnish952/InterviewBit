...
// As long as there is increasing sequence keep pushing elem to stack, once found a dec elem pop from stack till the element is less than or equal to top
// i.e there is no element towards left which is less than the curr elem
